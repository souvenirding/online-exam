...
<body style="background:url(${APP_PATH }/static/img/bg.jpg) ;background-size:cover; ">
	<div align="center">
		<form action="${APP_PATH }/manager/managerlogin" method="post"
			...
			<table>
				...
				<tr height="10">
					...
					<td width="10%"><button type="button"
							class="btn btn-default btn-sm" onclick="ghyzm()">
							验证码：<%=session.getAttribute("verifyCodeValue")%></button></td>
					<td>&nbsp;&nbsp;<input type="text" id="yzm" name="yzm"
						value="" /></td>
					<td width="30%"></td>
				</tr>
				<tr height="10"></tr>
